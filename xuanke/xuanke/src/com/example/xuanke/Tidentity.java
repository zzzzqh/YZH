...
import com.example.xuanke.Tidentity;
...
public class Tidentity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		querenxiugai=(Button) findViewById(R.id.button7);
		fanhui=(Button) findViewById(R.id.button8);
        ...
        querenxiugai.setOnClickListener(new OnClickListener() {
        	...
        	Bundle c=new Bundle();
				...
				Intent intent=new Intent(Tidentity.this,Yreset.class);
