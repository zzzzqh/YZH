...
public class Tmain extends Activity implements OnClickListener{
	...
	private void initView() {
		...
		View tab01 = yInflater.inflate(R.layout.ttab01, null);
		View tab02 = yInflater.inflate(R.layout.ttab02, null);
		View tab03 = yInflater.inflate(R.layout.ttab03, null);
				 						...
				 						try {
				 							...
				 							if(httpResponse.getStatusLine().getStatusCode()==HttpStatus.SC_OK){
				 								...
				 								if(result.equals("error")){
				 									 Toast.makeText(Tmain.this, "用户名不存在,或密码错误", 1).show();
...
//				 			     					 MainActivity.this.startActivity(intent);
				 						...
				 						{
				 							Toast.makeText(Tmain.this, "连接有问题", Toast.LENGTH_SHORT).show();
				 						}
				 				...
				 				ykkjhs.setOnItemSelectedListener(new OnItemSelectedListener() {
				 					...
				 					public void onItemSelected(AdapterView<?> arg0, View arg1,
				 							int arg2, long arg3) {
				 						// TODO Auto-generated method stub
				 						Toast.makeText(Tmain.this, list5.get(arg2), Toast.LENGTH_SHORT).show();
				 						kechengming=list5.get(arg2);
				 		            	Toast.makeText(Tmain.this, kechengming, Toast.LENGTH_SHORT).show();
				 		            	Bundle b=new Bundle();
				 		            	
				 						b.putString("zhuanye", zy);
				 						b.putString("kechengmingcheng", kechengming);
				 	                	Intent intent=new Intent(Tmain.this,Kechengxinxi.class);
		...
		case R.id.id_y_tab_tijiaoshenqing_img://点击开课计划书按钮跳转到修改个人信息界面
			...
			new AsyncTask<String, Void, Void>(){
				//
					 					@Override
					 					protected Void doInBackground(String... params) {
					 					String url="http://115.28.69.231/android/freshteachertype.php";
					 						HttpPost httprequest=new HttpPost(url);
					 						List<NameValuePair>param=new ArrayList<NameValuePair>();
					 						user u=new user();
					 				...
					 				Toast.makeText(Tmain.this, "提交申请成功", 1);
					 				break;
